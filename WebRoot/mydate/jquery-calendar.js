...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:65px;height:20px;margin-left:35px"><select id="calendar_newMonth" style="width:60px">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select" style="width:79px;height:20px;"><select id="calendar_newYear" style="width:65px">';
