...
<script type="text/javascript">
	...
	$(document).ready(function (){ 
		var treeNodes = '';
			$.ajax({
			    url : "${pageContext.request.contextPath}/wfuser/findWfuserForZtree.do",
			    data : {},
			    type : 'GET',
			    dataType : 'json',
			    success : function(json) {
				   treeNodes += "[{id:'a01',pId:'a00',name:'根节点'},";
	...
	function show(id,name){
		$.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/wfuser/findWfuserForZtree.do?pid="+id,
            dataType: "json",
