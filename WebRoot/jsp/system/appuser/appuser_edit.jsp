...
$(document).ready(function(){
	...
	function hasU(){
		...
		var url = "${pageContext.request.contextPath}/appuser/hasU.do?USERNAME="+USERNAME+"&tm="+new Date().getTime();
...
<body>
	<form action="${pageContext.request.contextPath}/appuser/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><br/><img src="${pageContext.request.contextPath}/images/jiazai.gif" /><br/><h4 class="lighter block green">提交中...</h4></div>
