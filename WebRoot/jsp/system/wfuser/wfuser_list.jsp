...
<ul class="breadcrumb">
	<li><i class="icon-home"></i> <a>工作流管理</a><span class="divider"><i class="icon-angle-right"></i></span></li>
	<li class="active">人员关系表</li>
</ul><!--.breadcrumb-->
...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			<form action="${pageContext.request.contextPath}/wfuser/findList.do?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm" id="userForm">
			<!-- 检索  -->
			<div style="border-bottom: 1px solid #eee;">
				<table>
					<tr>
						<td>&nbsp;&nbsp;<font color="#808080">用户名称：</font></td>
						<td><input type="text" name="yhmc" id="yhmc" value="${pd.wfuser }" style="width: 95%" placeholder="这里输入用户名称" title="用户名称"/></td>
...
<!--		<script type="text/javascript" src="js/attention/zDialog/zDialog.js"></script>-->
		...
		<%@include file="../../common/ztree/wfuser_ztree.jsp" %>
		...
		function add(){
			...
			if(m_id==''||m_id==null){
				...
				art.dialog.open('${pageContext.request.contextPath}/wfuser/toadd.do?pid='+m_id+'&pdqmc='+m_name,{
			   	 	title:'新增',
					width:640,
		    		height:420,
		    		lock: true
		...
		//修改
		function edit(id){
			art.dialog.open('${pageContext.request.contextPath}/wfuser/toedit.do?id='+id,{
		   	 	title:'编辑',
				width:320,
	    		height:400,
	    		lock: true
		...
		function del(id){
			bootbox.confirm("确定要删除该记录?", function(result) {
				if(result) {
					var url = "${pageContext.request.contextPath}/wfuser/remove.do?id="+id;
