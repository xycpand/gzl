...
<!--		<link rel="stylesheet" href="css/ace.min.css" />-->
		...
		<script type="text/javascript">
				...
				function save(){
					...
					$.ajax({
			            type: "POST",
			            url: '${pageContext.request.contextPath}/menu/editicon.do',
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/artDialog/plugins/iframeTools.source.js"></script>
	...
	<body>
		<form action="${pageContext.request.contextPath}/menu/editicon.do" name="menuForm" id="menuForm" method="post">
			...
			<div id="zhongxin2" class="center" style="display:none"><img src="${pageContext.request.contextPath}/images/jzx.gif" /></div>
		</form>
	</body>
</html>