...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/artDialog/plugins/iframeTools.source.js"></script>
	...
	<body>
		<form action="${pageContext.request.contextPath}/menu/edit.do" name="menuForm" id="menuForm" method="post">
			...
			<table>
				...
				<tr class="info">
					<td align="right">菜单名称:</td><td><input type="text" name="MENU_NAME" id="menuName" placeholder="这里输入菜单名称" value="${pd.MENU_NAME }" title="名称"/></td>
				</tr>
				<tr class="info">
					<td align="right">链接地址:</td><td><input type="text" name="MENU_URL" id="menuUrl" placeholder="这里输入链接地址" value="${pd.MENU_URL }" title="地址"/></td>
				</tr>
				<tr class="info">
					<td align="right">序号:</td><td><input type="number" name="MENU_ORDER" id="menuOrder" placeholder="这里输入序号" value="${pd.MENU_ORDER}" title="序号"/></td>
				</tr>
				<tr>
