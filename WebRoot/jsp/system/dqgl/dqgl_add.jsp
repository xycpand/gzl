...
<body>
	<c:if test="${pd.flag!='add'}">
		<form action="${pageContext.request.contextPath}/dqgl/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
			<div id="zhongxin">
			<table width="90%">
				<tr>
					<td width="20%" align="right">父节点：</td><td><input type="text" readonly value="${pd.pdqmc }" style="width: 95%" placeholder="父节点" title="父节点"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">地区名称：</td><td><input type="text" name="name" id="name" style="width: 95%" placeholder="这里输入地区名称" title="地区名称"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">排序：</td>
					<td><input type="text" name="px" id="px" style="width: 95%" placeholder="这里输入排序" title="排序"/></td>
				</tr>
				<tr>
