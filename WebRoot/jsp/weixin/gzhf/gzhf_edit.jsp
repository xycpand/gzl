...
<body>
	<form action="${pageContext.request.contextPath}/zdycd/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		...
		<table width="90%">
			<tr>
				<td width="20%" align="right">标题：</td><td><input type="text" name="bt" id="bt" value="${p.bt }" style="width: 95%" placeholder="这里输入标题" title="标题"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">内容：</td>
				<td>
					<textarea rows="8" cols="8" name="nr" id="nr">${p.nr }</textarea>
				</td>
			</tr>
			<tr>
