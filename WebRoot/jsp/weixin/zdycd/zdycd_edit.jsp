...
<body>
	<form action="${pageContext.request.contextPath}/zdycd/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		...
		<table width="90%">
			<tr>
				<td width="20%" align="right">菜单名称：</td><td><input type="text" name="cdmc" id="cdmc" value="${p.cdmc }" style="width: 95%" placeholder="这里输入菜单名称" title="菜单名称"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">排序：</td><td><input type="text" name="px" id="px" value="${p.px }" style="width: 95%" placeholder="排序" title="排序"/></td>
			</tr>
			<tr>
				<td style="text-align: center;" colspan="2">
					...
					<input type="hidden" id="cdjb" value="${p.cdjb }">
				</td>
			</tr>
		</table>
		</div>
