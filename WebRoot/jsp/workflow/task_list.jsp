						...
						<c:forEach items="${list}" var="var" varStatus="vs">
							...
							<tr>
								...
								<td style="width: 180px;">
									<a class='btn btn-mini btn-info' title="办理任务" onclick="findTaskInfo('${var.id }');">办理任务</a>&nbsp;
									<a class='btn btn-mini btn-info' title="查看流程图" onclick="findViewImage('${var.processInstanceId }');">查看流程图</a>
								</td>
							</tr>
						</c:forEach>
						</c:if>
...
<!--		<script type="text/javascript" src="js/attention/zDialog/zDialog.js"></script>-->
		...
		function findTaskInfo(id){
			art.dialog.open('${pageContext.request.contextPath}/workflow/findTaskInfo.do?id='+id,{
		   	 	title:'处理代办任务',
				width:820,
	    		height:420,
	    		lock: true
