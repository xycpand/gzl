...
import com.jalan.entity.system.User;
import com.jalan.util.Tools;
*//**
 * 
* 类名称：UserExcelView.java
* 类描述： 
* @author fuhang
* 作者单位： 
* 联系方式：
...
public class UserExcelView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		for(int i=0; i<userCount; i++){
			...
			String lastLogin = user.getLastLogin()!=null ? user.getLastLogin() : null;
			cell = getCell(sheet, i+1, 3);
			cell.setCellStyle(contentStyle);
			//setText(cell,Tools.date2Str(lastLogin));
			setText(cell,lastLogin);
		}
